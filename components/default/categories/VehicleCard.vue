...
<template>
  <a href="#" class="rounded overflow-hidden shadow-lg">
    ...
    <div class="px-6 py-4">
      <div class="default-categories_text font-bold text-xl mb-2">{{vehicleName()}}</div>
    ...
    <button class="px-6 p2-4 pb-2">
      <span class="default-categories_button inline-block rounded-full px-5 py-3 text-md font-semibold mr-2 mb-2">Ver mais</span>
    </button>
  </a>
</template>